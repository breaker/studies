...
//
// Note: This file has been edited for use in Beginning Game Programming, 3Ed
...
// Call Open() to open a wave file for reading.
// Then call Read() as needed.
CWaveFile::CWaveFile()
{
    m_pwfx    = NULL;
    m_hmmio   = NULL;
...
// Calling the destructor or Close() will close the file.
CWaveFile::~CWaveFile()
{
    Close();
