...
#ifndef __TEXQUAD_H__
#define __TEXQUAD_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "TexQuad"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CTexQuadApp;
extern CTexQuadApp     g_TexQuadApp;  // 应用程序实例
...
class CTexQuadApp : public CWinApp {
public:
    CTexQuadApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
