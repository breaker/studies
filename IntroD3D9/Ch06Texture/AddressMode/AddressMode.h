...
#undef MODULE_NAME
#define MODULE_NAME     "AddressMode"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CAddressModeApp;
extern CAddressModeApp     g_AddressModeApp;  // 应用程序实例
...
class CAddressModeApp : public CWinApp {
public:
    CAddressModeApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
