...
int CLaserApp::Exit(int exitCode) {
...
BOOL CLaserApp::InitModulePath(DWORD size) {
...
BOOL CLaserApp::InitWorkDir(const _TCHAR* dir) {
...
CString CLaserApp::GetModuleDir() const {
...
int CLaserApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderLaser> render(new RenderLaser());
    ...
    auto_ptr<LaserInput> input(new LaserInput());
