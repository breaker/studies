...
int CFireworkApp::Exit(int exitCode) {
...
BOOL CFireworkApp::InitModulePath(DWORD size) {
...
BOOL CFireworkApp::InitWorkDir(const _TCHAR* dir) {
...
int CFireworkApp::Run() {
    ...
    auto_ptr<FireworkInput> input(new FireworkInput());
