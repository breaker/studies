...
class RenderFirework : public SGL::Render {
public:
    RenderFirework() : m_Camera(SGL::Camera::CAMERA_AIR) {}
...
private:
    ...
    std::auto_ptr<SGL::PSystem> m_Explosion;
...
class FireworkInput : public SGL::Input {
public:
