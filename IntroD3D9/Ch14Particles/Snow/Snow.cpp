...
int CSnowApp::Exit(int exitCode) {
...
BOOL CSnowApp::InitModulePath(DWORD size) {
...
BOOL CSnowApp::InitWorkDir(const _TCHAR* dir) {
...
CString CSnowApp::GetModuleDir() const {
...
int CSnowApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderSnow> render(new RenderSnow());
    ...
    auto_ptr<SnowInput> input(new SnowInput());
