...
#ifndef __MIRRORSHADOW_H__
#define __MIRRORSHADOW_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "MirrorShadow"        // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CMirrorShadowApp;
extern CMirrorShadowApp       MirrorShadowApp;      // 应用程序实例
...
class CMirrorShadowApp : public CWinApp {
public:
    CMirrorShadowApp() {}
