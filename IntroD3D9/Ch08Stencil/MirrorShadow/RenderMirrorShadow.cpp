// RenderMirrorShadow.cpp
//

#include "StdAfx.h"
#include "MirrorShadow.h"
#include "RenderMirrorShadow.h"

////////////////////////////////////////////////////////////////////////////////
// 渲染类 RenderMirrorShadow
////////////////////////////////////////////////////////////////////////////////

LPCTSTR RenderMirrorShadow::TEX_FLOOR = _T("checker.jpg");
LPCTSTR RenderMirrorShadow::TEX_WALL = _T("brick0.jpg");
LPCTSTR RenderMirrorShadow::TEX_MIRROR = _T("ice.bmp");

D3DMATERIAL9 RenderMirrorShadow::FloorMtrl    = SGL::WHITE_MTRL;
D3DMATERIAL9 RenderMirrorShadow::WallMtrl     = SGL::WHITE_MTRL;
D3DMATERIAL9 RenderMirrorShadow::MirrorMtrl   = SGL::WHITE_MTRL;
D3DMATERIAL9 RenderMirrorShadow::TeapotMtrl   = SGL::YELLOW_MTRL;

BOOL RenderMirrorShadow::Init(UINT width, UINT height, HWND hwnd, BOOL windowed, D3DDEVTYPE devType)
{
...
void RenderMirrorShadow::Display(float timeDelta)
{
...
void RenderMirrorShadow::DrawScene()
{
    // draw teapot
...
void RenderMirrorShadow::DrawShadow()
{
...
void RenderMirrorShadow::DrawMirror()
{
...
////////////////////////////////////////////////////////////////////////////////
// 输入处理类 MirrorShadowInput
////////////////////////////////////////////////////////////////////////////////

void MirrorShadowInput::ProcessInput(float timeDelta)
{
    RenderMirrorShadow* render = (RenderMirrorShadow*) m_Main->GetRender();
