...
#ifndef __RENDERMIRRORSHADOW_H__
#define __RENDERMIRRORSHADOW_H__
...
class RenderMirrorShadow : public SGL::Render {
public:
    RenderMirrorShadow() : m_TeapotPos(0.0f, 3.0f, -7.5f), m_ViewRadius(20.0f), m_ViewAngle(3.0f * D3DX_PI / 2.0f) {}
...
class MirrorShadowInput : public SGL::Input {
public:
    virtual void ProcessInput(float timeDelta);
};

#endif  // __RENDERMIRRORSHADOW_H__
