...
#ifndef __RENDERMIRROR_H__
#define __RENDERMIRROR_H__
...
class RenderMirror : public SGL::Render {
public:
    RenderMirror() : m_TeapotPos(0.0f, 3.0f, -7.5f), m_ViewRadius(20.0f), m_ViewAngle(3.0f * D3DX_PI / 2.0f) {}
...
class MirrorInput : public SGL::Input {
public:
    virtual void ProcessInput(float timeDelta);
};

#endif  // __RENDERMIRROR_H__
