...
#ifndef __INITD3D1_H__
#define __INITD3D1_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "InitD3D1"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CInitD3D1App;
extern CInitD3D1App     g_InitD3D1App;  // 应用程序实例
...
class CInitD3D1App : public CWinApp {
public:
    CInitD3D1App() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
