...
CCreateTextApp g_CreateTextApp;   // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CCreateTextApp
////////////////////////////////////////////////////////////////////////////////

BOOL CCreateTextApp::InitInstance()
{
...
int CCreateTextApp::Exit(int exitCode)
{
...
void CCreateTextApp::InitLocale()
{
...
BOOL CCreateTextApp::InitModulePath(DWORD size)
{
...
BOOL CCreateTextApp::InitWorkDir(const _TCHAR* dir)
{
