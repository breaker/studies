...
CID3DXFontApp g_ID3DXFontApp;   // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CID3DXFontApp
////////////////////////////////////////////////////////////////////////////////

BOOL CID3DXFontApp::InitInstance()
{
...
int CID3DXFontApp::Exit(int exitCode)
{
...
BOOL CID3DXFontApp::InitModulePath(DWORD size)
{
...
BOOL CID3DXFontApp::InitWorkDir(const _TCHAR* dir)
{
...
CString CID3DXFontApp::GetModuleDir() const
{
