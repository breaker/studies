...
inline BOOL MFCPreTransMessage(__out MSG* msg, HWND) {
...
public:
    ...
    typedef BOOL (*PreTransMessageFunc)(__out MSG*, HWND);
    typedef BOOL (*PumpMessageFunc)(__out int*, HWND, IdleFunc, PreTransMessageFunc);
    ...
    int StartLoop(HWND hwnd, IdleFunc idleFunc, PreTransMessageFunc preTransFunc, PUMPMSG_TYPE type = PUMPMSG_PEEK);

protected:
    static BOOL PeekMessage(__out int* exitCode, HWND hwnd, IdleFunc idleFunc, PreTransMessageFunc preTransFunc);
    static BOOL GetMessage(__out int* exitCode, HWND hwnd, IdleFunc idleFunc, PreTransMessageFunc preTransFunc);

    static void DefIdle() {}
    static BOOL DefPreTransMessage(__out MSG*, HWND) {
        return FALSE;
    }
