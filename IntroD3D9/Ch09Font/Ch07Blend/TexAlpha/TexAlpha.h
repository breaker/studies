...
#ifndef __TEXALPHA_H__
#define __TEXALPHA_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "TexAlpha"       // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CTexAlphaApp;
extern CTexAlphaApp      g_TexAlphaApp;   // 应用程序实例
...
class CTexAlphaApp : public CWinApp {
public:
    CTexAlphaApp() {}
