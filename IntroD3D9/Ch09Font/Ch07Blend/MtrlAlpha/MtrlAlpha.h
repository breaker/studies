...
#ifndef __MTRLALPHA_H__
#define __MTRLALPHA_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "MtrlAlpha"       // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CMtrlAlphaApp;
extern CMtrlAlphaApp      g_MtrlAlphaApp;   // 应用程序实例
...
class CMtrlAlphaApp : public CWinApp {
public:
    CMtrlAlphaApp() {}
