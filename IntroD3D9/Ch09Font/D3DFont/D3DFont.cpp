...
CD3DFontApp g_D3DFontApp;   // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CD3DFontApp
////////////////////////////////////////////////////////////////////////////////

BOOL CD3DFontApp::InitInstance()
{
...
int CD3DFontApp::Exit(int exitCode)
{
...
BOOL CD3DFontApp::InitModulePath(DWORD size)
{
...
BOOL CD3DFontApp::InitWorkDir(const _TCHAR* dir)
{
...
CString CD3DFontApp::GetModuleDir() const
{
...
int CD3DFontApp::Run()
{
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderD3DFont> render(new RenderD3DFont());
    if (!render->Init(WIN_WIDTH, WIN_HEIGHT, hwnd, windowed, D3DDEVTYPE_HAL))
        return Exit(-1);

    auto_ptr<D3DFontInput> input(new D3DFontInput());
