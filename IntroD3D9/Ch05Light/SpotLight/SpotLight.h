...
#undef MODULE_NAME
#define MODULE_NAME     "SpotLight"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CSpotLightApp;
extern CSpotLightApp     g_SpotLightApp;  // 应用程序实例
...
class CSpotLightApp : public CWinApp {
public:
    CSpotLightApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
