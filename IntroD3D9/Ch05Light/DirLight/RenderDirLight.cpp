...
////////////////////////////////////////////////////////////////////////////////
// 绘制物体类 RenderDirLight
////////////////////////////////////////////////////////////////////////////////

RenderDirLight::RenderDirLight(UINT width, UINT height, HWND hwnd, BOOL windowed, D3DDEVTYPE devType)
...
BOOL RenderDirLight::initRender()
{
...
// 初始化材质
BOOL RenderDirLight::initMaterial()
{
...
// 初始化光照
BOOL RenderDirLight::initDirLight()
{
    D3DXVECTOR3 dir(1.0f, -0.0f, 0.25f);
    D3DXCOLOR clr = SGL::WHITE;
    D3DLIGHT9 dirLight;
    SGL::InitDirectionalLight(dirLight, dir, clr);
...
// 初始化摄像机
BOOL RenderDirLight::initCamera()
{
    // 设置投影 (project)
    D3DXMATRIX proj;
...
void RenderDirLight::render(float timeDelta)
{
