...
#undef MODULE_NAME
#define MODULE_NAME     "DirLight"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CDirLightApp;
extern CDirLightApp     g_DirLightApp;  // 应用程序实例
...
class CDirLightApp : public CWinApp {
public:
    CDirLightApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
