...
int CToonApp::Exit(int exitCode) {
...
BOOL CToonApp::InitModulePath(DWORD size) {
...
BOOL CToonApp::InitWorkDir(const _TCHAR* dir) {
...
CString CToonApp::GetModuleDir() const {
...
int CToonApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderToon> render(new RenderToon());
    ...
    auto_ptr<ToonInput> input(new ToonInput());
