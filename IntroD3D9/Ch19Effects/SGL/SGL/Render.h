...
const D3DMATERIAL9 BLACK_MTRL   = InitMaterial(BLACK, BLACK, BLACK, BLACK, 2.0f);
...
public:
    ...
    HRESULT Init(UINT width, UINT height, HWND hwnd, BOOL windowed, D3DDEVTYPE devType, D3DFORMAT bkBufFmt = D3DFMT_A8R8G8B8, D3DMULTISAMPLE_TYPE sampleType = D3DMULTISAMPLE_NONE, D3DFORMAT depthStencilFmt = D3DFMT_D24S8);
