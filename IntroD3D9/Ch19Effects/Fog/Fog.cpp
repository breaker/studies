...
BOOL CFogApp::InitModulePath(DWORD size) {
...
BOOL CFogApp::InitWorkDir(const _TCHAR* dir) {
...
CString CFogApp::GetModuleDir() const {
...
int CFogApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderFog> render(new RenderFog());
    ...
    auto_ptr<FogInput> input(new FogInput());
