...
CXFileApp XFileApp; // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CXFileApp
////////////////////////////////////////////////////////////////////////////////

BOOL CXFileApp::InitInstance()
{
...
int CXFileApp::Exit(int exitCode)
{
...
BOOL CXFileApp::InitModulePath(DWORD size)
{
...
BOOL CXFileApp::InitWorkDir(const _TCHAR* dir)
{
...
CString CXFileApp::GetModuleDir() const
{
...
int CXFileApp::Run()
{
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderXFile> render(new RenderXFile());
    ...
    auto_ptr<XFileInput> input(new XFileInput());
