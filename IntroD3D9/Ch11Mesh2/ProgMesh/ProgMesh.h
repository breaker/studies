...
#ifndef __PROGMESH_H__
#define __PROGMESH_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "ProgMesh"     // 程序模块名

#define BUF_SIZE        256         // 常用缓冲区大小

class CProgMeshApp;
extern CProgMeshApp        ProgMeshApp;   // 应用程序实例
...
class CProgMeshApp : public CWinApp {
public:
    CProgMeshApp() {}
