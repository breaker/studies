...
CProgMeshApp ProgMeshApp; // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CProgMeshApp
////////////////////////////////////////////////////////////////////////////////

BOOL CProgMeshApp::InitInstance()
{
...
int CProgMeshApp::Exit(int exitCode)
{
...
BOOL CProgMeshApp::InitModulePath(DWORD size)
{
...
BOOL CProgMeshApp::InitWorkDir(const _TCHAR* dir)
{
...
int CProgMeshApp::Run()
{
    ...
    auto_ptr<ProgMeshInput> input(new ProgMeshInput());
