...
CBoundingApp BoundingApp; // 应用程序实例

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CBoundingApp
////////////////////////////////////////////////////////////////////////////////

BOOL CBoundingApp::InitInstance()
{
...
int CBoundingApp::Exit(int exitCode)
{
...
BOOL CBoundingApp::InitModulePath(DWORD size)
{
...
BOOL CBoundingApp::InitWorkDir(const _TCHAR* dir)
{
...
int CBoundingApp::Run()
{
    ...
    auto_ptr<BoundingInput> input(new BoundingInput());
