...
// 应用程序实例
CTerrain1App Terrain1App;

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CTerrain1App
////////////////////////////////////////////////////////////////////////////////

BOOL CTerrain1App::InitInstance() {
...
int CTerrain1App::Exit(int exitCode) {
...
BOOL CTerrain1App::InitModulePath(DWORD size) {
...
BOOL CTerrain1App::InitWorkDir(const _TCHAR* dir) {
...
int CTerrain1App::Run() {
    ...
    auto_ptr<Terrain1Input> input(new Terrain1Input());
