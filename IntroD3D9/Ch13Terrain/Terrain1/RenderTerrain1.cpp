...
#include "StdAfx.h"
#include "Terrain1.h"
#include "RenderTerrain1.h"

////////////////////////////////////////////////////////////////////////////////
// 渲染类 RenderTerrain1
////////////////////////////////////////////////////////////////////////////////

LPCTSTR RenderTerrain1::MeshDumpFile = _T("MeshDump.txt");
LPCTSTR RenderTerrain1::HeightMapFile = _T("coastMountain64.raw");

BOOL RenderTerrain1::Init(UINT width, UINT height, HWND hwnd, BOOL windowed, D3DDEVTYPE devType) {
    ...
    if (!m_Terrain->Init(m_D3DDev, HeightMapFile, 64, 64, 10, 0.5f, D3DFMT_INDEX16))
        return FALSE;
...
void RenderTerrain1::DumpMesh(LPCTSTR fname, ID3DXMesh* mesh) {
    MeshDump dump;
    if (!dump.Init(fname))
        return;
...
void RenderTerrain1::Draw(float timeDelta) {
    D3DXVECTOR3 pos;
...
void Terrain1Input::ProcessInput(float timeDelta) {
    RenderTerrain1* render = (RenderTerrain1*) m_Main->GetRender();
