...
// 应用程序实例
CTerrain2App Terrain2App;

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CTerrain2App
////////////////////////////////////////////////////////////////////////////////

BOOL CTerrain2App::InitInstance() {
...
int CTerrain2App::Exit(int exitCode) {
...
BOOL CTerrain2App::InitModulePath(DWORD size) {
...
BOOL CTerrain2App::InitWorkDir(const _TCHAR* dir) {
...
int CTerrain2App::Run() {
    ...
    auto_ptr<Terrain2Input> input(new Terrain2Input());
