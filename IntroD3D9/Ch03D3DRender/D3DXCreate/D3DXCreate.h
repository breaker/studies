...
#ifndef __D3DXCREATE_H__
#define __D3DXCREATE_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "D3DXCreate"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CD3DXCreateApp;
extern CD3DXCreateApp     g_D3DXCreateApp;  // 应用程序实例
...
class CD3DXCreateApp : public CWinApp {
public:
    CD3DXCreateApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
