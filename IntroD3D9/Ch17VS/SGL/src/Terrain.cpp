...
BOOL Terrain::ComputeVertex() {
    ...
    SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "IDirect3DDevice9::CreateVertexBuffer", hr); return FALSE);
...
BOOL Terrain::ComputeIndex() {
    ...
    if (m_IndexBufFormat == D3DFMT_INDEX16) {
        ...
        SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "IDirect3DDevice9::CreateIndexBuffer", hr); return FALSE);
...
BOOL Terrain::LoadTexture(LPCTSTR fname) {
    ...
    SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "D3DXCreateTextureFromFile", hr); return FALSE);
    return TRUE;
}
...
BOOL Terrain::GenTexture(D3DXVECTOR3* dirToLight) {
    ...
    SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "D3DXCreateTexture", hr); return FALSE);
    ...
    SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "D3DXFilterTexture", hr); return FALSE);
...
BOOL Terrain::Draw(D3DXMATRIX* world, BOOL drawTris) {
    if (m_D3DDev) {
        ...
        SGL_FAILED_DO(hr, SGL_MRPTDX(_CRT_ERROR, "IDirect3DDevice9::DrawIndexedPrimitive", hr); return FALSE);
    }
    return TRUE;
}
