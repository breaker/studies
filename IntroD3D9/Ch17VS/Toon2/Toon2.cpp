...
int CToon2App::Exit(int exitCode) {
...
BOOL CToon2App::InitModulePath(DWORD size) {
...
BOOL CToon2App::InitWorkDir(const _TCHAR* dir) {
...
CString CToon2App::GetModuleDir() const {
...
int CToon2App::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderToon2> render(new RenderToon2());
    ...
    auto_ptr<Toon2Input> input(new Toon2Input());
