...
// 应用程序实例
CDiffuseApp DiffuseApp;

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CDiffuseApp
////////////////////////////////////////////////////////////////////////////////

BOOL CDiffuseApp::InitInstance() {
...
int CDiffuseApp::Exit(int exitCode) {
...
BOOL CDiffuseApp::InitModulePath(DWORD size) {
...
BOOL CDiffuseApp::InitWorkDir(const _TCHAR* dir) {
...
CString CDiffuseApp::GetModuleDir() const {
...
int CDiffuseApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderDiffuse> render(new RenderDiffuse());
    ...
    auto_ptr<DiffuseInput> input(new DiffuseInput());
