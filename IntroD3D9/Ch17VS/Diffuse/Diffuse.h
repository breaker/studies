...
// 程序模块名
const char      MODULE_NAMEA[]  = "Diffuse";
const wchar_t   MODULE_NAMEW[]  = L"Diffuse";
const _TCHAR    MODULE_NAME[]   = _T("Diffuse");
...
class CDiffuseApp : public CWinApp {
public:
    CDiffuseApp() {}
