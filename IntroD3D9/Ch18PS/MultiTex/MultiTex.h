...
// 程序模块名
const char      MODULE_NAMEA[]  = "MultiTex";
const wchar_t   MODULE_NAMEW[]  = L"MultiTex";
const _TCHAR    MODULE_NAME[]   = _T("MultiTex");
...
// 应用程序实例
class CMultiTexApp;
extern CMultiTexApp MultiTexApp;
...
class CMultiTexApp : public CWinApp {
public:
    CMultiTexApp() {}
