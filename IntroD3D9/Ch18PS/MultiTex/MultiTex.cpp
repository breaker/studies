...
// 应用程序实例
CMultiTexApp MultiTexApp;

////////////////////////////////////////////////////////////////////////////////
// 应用程序类 CMultiTexApp
////////////////////////////////////////////////////////////////////////////////

BOOL CMultiTexApp::InitInstance() {
...
int CMultiTexApp::Exit(int exitCode) {
...
BOOL CMultiTexApp::InitModulePath(DWORD size) {
...
BOOL CMultiTexApp::InitWorkDir(const _TCHAR* dir) {
...
int CMultiTexApp::Run() {
    ...
    auto_ptr<MultiTexInput> input(new MultiTexInput());
