...
#ifndef __COLORTRIANGLE_H__
#define __COLORTRIANGLE_H__
...
#undef MODULE_NAME
#define MODULE_NAME     "ColorTriangle"      // 程序模块名

#define BUF_SIZE        256             // 常用缓冲区大小

class CColorTriangleApp;
extern CColorTriangleApp     g_ColorTriangleApp;  // 应用程序实例
...
class CColorTriangleApp : public CWinApp {
public:
    CColorTriangleApp() : m_GameRun(NULL), m_PumpMsgFunc(NULL), m_ExitCode(0) {}
