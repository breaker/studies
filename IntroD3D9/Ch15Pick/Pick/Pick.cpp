...
int CPickApp::Exit(int exitCode) {
...
BOOL CPickApp::InitModulePath(DWORD size) {
...
BOOL CPickApp::InitWorkDir(const _TCHAR* dir) {
...
CString CPickApp::GetModuleDir() const {
...
int CPickApp::Run() {
    ...
    BOOL windowed = TRUE;
    auto_ptr<RenderPick> render(new RenderPick());
    ...
    auto_ptr<PickInput> input(new PickInput());
