// RenderTestCamera.cpp
//

#include "StdAfx.h"
#include "TestCamera.h"
#include "RenderTestCamera.h"
...
////////////////////////////////////////////////////////////////////////////////
// 渲染类 RenderTestCamera
////////////////////////////////////////////////////////////////////////////////

LPCTSTR RenderTestCamera::MeshDumpFile = _T("MeshDump.txt");

BOOL RenderTestCamera::Init(UINT width, UINT height, HWND hwnd, BOOL windowed, D3DDEVTYPE devType)
{
...
BOOL RenderTestCamera::InitFont()
{
...
void RenderTestCamera::DumpMesh(LPCTSTR fname, ID3DXMesh* mesh)
{
    MeshDump dump;
    if (!dump.Init(fname))
        return;
...
void RenderTestCamera::Draw(float timeDelta)
{
...
////////////////////////////////////////////////////////////////////////////////
// 输入处理类 TestCameraInput
////////////////////////////////////////////////////////////////////////////////

void TestCameraInput::ProcessInput(float timeDelta)
{
    RenderTestCamera* render = (RenderTestCamera*) m_Main->GetRender();
