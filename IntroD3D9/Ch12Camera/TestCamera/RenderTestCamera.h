...
#ifndef __RENDERTESTCAMERA_H__
#define __RENDERTESTCAMERA_H__
...
class RenderTestCamera : public SGL::Render {
public:
    RenderTestCamera() : m_Camera(SGL::Camera::CAMERA_LAND) {}
...
class TestCameraInput : public SGL::Input {
public:
    virtual void ProcessInput(float timeDelta);
};

#endif  // __RENDERTESTCAMERA_H__
